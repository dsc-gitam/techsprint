                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            <svg className='w-6 h-5 sm:w-8 sm:h-6' width="504" height="504" viewBox="0 0 504 504" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="text-base sm:text-lg font-bold text-[#202124] flex items-end">
                                ...
                                <span className="relative">
                                    p
                                    <span className='absolute top-[80%] left-[1px] w-[1.5px] sm:w-[2px] h-3 sm:h-3.5 bg-[#202124]'></span>
                                </span>
                                <span>rint</span>
                            </span>
                        </div>
