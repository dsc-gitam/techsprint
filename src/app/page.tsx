...
export default function Home() {
    return (
        <main className="min-h-screen bg-white">
            ...
            <footer className="bg-white border-t border-[#e8eaed] py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        {/* Logo */}
                        <div className="flex items-center gap-2">
                            <svg className='w-8 h-6' width="504" height="504" viewBox="0 0 504 504" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="text-lg font-bold text-[#202124] relative">
                                TechS<span>p<div className='absolute -bottom-1 left-[46px] w-[2px] h-3 bg-[#202124]'></div></span>rint
                            </span>
                        </div>
