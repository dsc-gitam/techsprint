                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center">
                            <Link href="/" className="flex items-center gap-2">
                                <svg className='w-8 h-6 sm:w-10 sm:h-8' width="504" height="504" viewBox="0 0 504 504" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="text-lg sm:text-xl font-bold text-[#202124] flex items-end">
                                    <span>TechS</span>
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            ...
                            {user ? (
                                ...
                                <button
                                    ...
                                    className="bg-[#4285F4] text-white px-6 py-2.5 rounded-full font-medium hover:bg-[#3367D6] transition-all"
                                >
                                    Sign in
                                </button>
                            )}
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden border-t border-[#e8eaed] bg-white">
                        <div className="px-4 py-4 space-y-3">
                            <Link
                                href="/#about"
                                className="block py-3 px-4 text-[#202124] font-medium hover:bg-[#f8f9fa] rounded-lg transition-colors"
                            ...
                            {user ? (
                                <Link
                                    href="/dashboard"
                                    className="flex items-center gap-3 py-3 px-4 text-[#202124] font-medium hover:bg-[#f8f9fa] rounded-lg transition-colors"
                                    onClick={() => setMobileMenuOpen(false)}
                                >
                                    {user.photoURL && (
                                        <img src={user.photoURL} alt="Profile" className="size-8 rounded-full border border-gray-200" />
                                    )}
                                    <span>Dashboard</span>
                                </Link>
                            ) : (
                                <button
                                    ...
                                    className="w-full bg-[#4285F4] text-white py-3 px-4 rounded-lg font-medium hover:bg-[#3367D6] transition-all text-center"
                                >
                                    Sign in with Google
                                </button>
                            )}
